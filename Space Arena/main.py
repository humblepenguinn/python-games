"""
space arena a python game made using the turtle library
"""
...
class Game(object):
    ...
    def render_info(self, pen, score, active_enemies):
        ...
        character_pen.draw_string(pen, "SPACE ARENA", 740, 270)
        character_pen.draw_string(pen, "SCORE {}".format(score), 740, 240)
        character_pen.draw_string(pen, "ENEMIES {}".format(active_enemies), 740, 210)
        character_pen.draw_string(pen, "LIVES {}".format(player.lives), 740, 180)
        character_pen.draw_string(pen, "LEVEL {}".format(game.level), 740, 150)
    ...
    def key_bindings(self):
        ...
        wn.onkeypress(player.slow_down, "Down")
    ...
    def splash_screen(self):
        ...
        character_pen.scale = 1.0
        character_pen.draw_string(pen, "BY SHAHARYAR AHMED", 0, 100)
    ...
    def main(self):
        while True:
            ...
            if game.state == "splash":
                ...
                game.render_info(pen, 0, num_of_active_enemies)
